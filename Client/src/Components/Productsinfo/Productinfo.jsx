...
import chardham from '../../assets/Banner2.jpg';
    ...
    <>
      ...
      <div className='flex flex-col justify-center items-center mx-8 md:mx-32 mb-20 mt-10 text-center'>
        ...
        <p className="mt-4 text-gray-600 text-lg md:text-xl max-w-3xl">
          Explore the spiritual journey of Chardham with us. Discover serene landscapes, sacred temples, and unforgettable experiences.
        </p>
      </div>
